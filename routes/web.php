...
Route::get('/all-product-customer', 'App\Http\Controllers\HomeController@all_product_customer');
...
Route::get('/chi-tiec-san-pham/{product_id}', 'App\Http\Controllers\ProductController@details_product');
...
Route::get('/delete-order/{orderId}', 'App\Http\Controllers\ProductController@delete_order');
...
Route::get('/active-slider/{slider_id}', 'App\Http\Controllers\BannerController@active_slider');
Route::get('/unactive-slider/{slider_id}', 'App\Http\Controllers\BannerController@unactive_slider');
