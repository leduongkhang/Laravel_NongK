...
class CheckoutController extends Controller
{
    ...
    //     //seo
    //      return with(compact('meta_desc','meta_keywords','meta_title','url_canonical'));
    // }
            ...
            if($feeship){
                ...
                if($count_feeship>0){
                   foreach($feeship as $key => $fee){
                        ...
                        Session::put('fee',10000); //phí vận chuyển mặt định niếu chưa thêm
                        Session::save();
    ...
    public function login_checkout(){
        ...
        return view('pages.checkout.login_check')->with('category',$cate_product)->with('brand',$brand_product)->with('slider',$slider);
    }
