    ...
    public function select_gallery(Request $request){
        ...
        if ($gallery_count > 0) {
            ...
            foreach ($gallery as $key => $gal) {
                ...
                // Nếu là dòng đầu tiên (i == 1), không cho thao tác
                if ($i == 1) {
                    $output .= '
                        <tr>
                            <td>'.$i.'</td>
                            ...
                            <td>
                                ...
                                <input type="file" style="width:40%" disabled />
                            </td>
                            <td>
                                <button type="button" class="btn btn-xs btn-secondary" disabled>Không thao tác</button>
                            </td>
                        </tr>
                    ';
                } else {
                    // Các dòng còn lại được thao tác bình thường
                    $output .= '
                        <tr>
                            <td>'.$i.'</td>
